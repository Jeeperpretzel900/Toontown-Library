...
<meta http-equiv="imagetoolbar" content="no">
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      ...
      hitbox.HB_PlaceName("_test_browserTestResult");
...
<table align="center" cellspacing="0" cellpadding="0" border="0"><tr><td><script type="text/javascript" src="http://disney.go.com/globalmedia/chrome/chrome.js"></script></td></tr></table>
      ...
      <tr>
        <td colspan="2">
      <tr>
    <td colspan="2" height="150" align="center" valign="middle">
      <img src="http://play.toontown.com/shared/images/logos/TT_logo_Lg64.gif" width="304" height="125" alt="Disney's Toontown Online" border="0">
    </td>
  </tr>
  ...
  <tr>
    <td align="center" valign="middle">
      <img src="http://play.toontown.com/shared/images/headers/warning.gif" width="424" height="55" alt="WARNING!" border="0">
    </td>
  </tr>
        ...
        <tr>
          <td align="left">
            <font face="arial,helvetica" size="2">
              Some operating systems and browsers are not supported by Toontown and Toontown.com, but you are welcome to view the site content at your own risk. We recommend the following:<br><br>               
              <b>To browse Web site content, download, &amp; play Toontown:</b>
              <ol>                
                <li>Adobe Flash Player 8+</li>
                <li>PC running Microsoft Windows 98, ME, 2000, XP, or later with Internet Explorer 5.01 (or newer) OR</li>
                <li>Mac OSX 10.4.6 (Tiger) with Safari 2.0 or later</li> 
              </ol>
              <b>To browse Web site content only:</b>
              <ol>
                <li>Adobe Flash Player 8+</li>
                <li>Firefox 1.0+, Netscape 7.0+ or Opera 8.0+</li>
              </ol>
            </td>
          </tr>
        </table>
  ...
  <tr>
    <td colspan="2" align="center">
      <form action="" method="post">
        <br>
        <input type="image" src="http://play.toontown.com/shared/images/buttons/tt_but_large_Iagree.gif" width="180" height="44"  name="bumBrowser" value="I Agree">
      </form>
    </td>
  </tr>
