...
<meta http-equiv="imagetoolbar" content="no">
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      <script type="text/javascript">
      hitbox = new HB_CreateObject("/toontown/US/PROSPECT/BROWSERTEST");
      hitbox.HB_PlaceAccount("DM53030620EW42EN3","DM510612FMNS38EN3","DM51030813MR38EN3","DM5103083LCA38EN3");
      hitbox.HB_PlaceName("_test_upgradeFlash");
...
<table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
  ...
  <tr>
    <td align="center">
      <font color="#999999" face="arial,helvetica">
      <h3>Adobe Flash Player 8 Required</h3>
      </font>
    </td>
  </tr>
  <tr>
          ...
          <td>
            <font face="arial,helvetica" size="2">
              <span style="float: right">
                <a href="javascript:popDisclaimer('http://www.adobe.com/go/gntray_dl_getflashplayer');"><img src="/shared/images/flash/get_flash_player.gif" border="0" width="88" height="31" alt="Get Adobe Flash Player"></a>
              </span>
              This web site makes use of <a href="javascript:popDisclaimer('http://www.adobe.com/go/gntray_dl_getflashplayer');">Adobe<sup><font size="-2">&reg;</font></sup> Flash <sup><font size="-2">TM</font></sup></a> software.  You have an old version of Adobe Flash Player that cannot play the content we've created.  Why not download and install the latest version now? It will only take a moment.<br>
            </font> 
          </td>
        </tr>
      </table> 
