...
<body id='us' onload="javascript:window_onload(); " onunload="if(APPopupFlag){LaunchAPPopup();} "  bgcolor="#4477ff" style="margin-top:0;margin-bottom:0;" >
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr height="40" valign="bottom">
    ...
    <img src="http://play.toontown.com/shared/images/buttons/print_red.gif" width=" 100" height="23" border="0" alt="Print page">
    </a>
    </font></td>
  </tr>
...
<!--    Internet Explorer should now be configured to prompt you with a yellow bar at the top of your browser window when it wants to install the Toontown ActiveX control.  <br><br>
    ...
    <img src="http://play.toontown.com/shared/images/activeX_message2.jpg" width="424" height="123" border="0" alt="example ActiveX information message">
    <br><br>
...
-->
    ...
    <br>
    <b><a href="http://play.toontown.com/ActiveXproblem.php" onClick="null;">Click here</a> for more information on installing the Toontown ActiveX control.</b>
