...
<img border=0 width=718 height=151 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_header.jpg"></a></td>

</tr>
<tr>

<td valign=top align=left><table width=121 height=538 border=0 cellpadding=0 cellspacing=0 align=left valign=top>
  <tr><td valign=top align=right background="http://media.toontown.com/toontown//sv1.3.1/images/cloud_leftBar.jpg">
  <font size=-2><br></font>
...
if (document.images) {
  ...
  button_about_on.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_about_on.gif";
  button_about_off = new Image();
  button_about_off.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_about.gif";

  button_screenshots_on = new Image();
  button_screenshots_on.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_screenshots_on.gif";
  button_screenshots_off = new Image();
  button_screenshots_off.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_screenshots.gif";

  button_faq_on = new Image();
  button_faq_on.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_faq_on.gif";
  button_faq_off = new Image();
  button_faq_off.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_faq.gif";

  button_news_on = new Image();
  button_news_on.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_news_on.gif";
  button_news_off = new Image();
  button_news_off.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_news.gif";

  button_reportbug_on = new Image();
  button_reportbug_on.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_reportbug_on.gif";
  button_reportbug_off = new Image();
  button_reportbug_off.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_reportbug.gif";

  button_account_on = new Image();
  button_account_on.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_account_on.gif";
  button_account_off = new Image();
  button_account_off.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_account.gif";


  play_on = new Image();
  play_on.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_play_on.gif";
  play_off = new Image();
  play_off.src = "http://media.toontown.com/toontown//sv1.3.1/images/button_play.gif";
}
</script>
    <img border=0 src="http://media.toontown.com/toontown//sv1.3.1/images/button_account.gif" name="button_account"
  ...
  <a href="news.php"
    ...
    <img border=0 src="http://media.toontown.com/toontown//sv1.3.1/images/button_news.gif" name="button_news"></a><br>
  <a href="about.php"
    onMouseOver="imgOn('button_about')"
    onMouseOut="imgOff('button_about')">
    <img border=0 src="http://media.toontown.com/toontown//sv1.3.1/images/button_about.gif" name="button_about"></a><br>
  <a href="screenShots.php"
    onMouseOver="imgOn('button_screenshots')"
    onMouseOut="imgOff('button_screenshots')">
    <img border=0 src="http://media.toontown.com/toontown//sv1.3.1/images/button_screenshots.gif" name="button_screenshots"></a><br>
  <a href="faq.php"
    onMouseOver="imgOn('button_faq')"
    onMouseOut="imgOff('button_faq')">
    <img border=0 src="http://media.toontown.com/toontown//sv1.3.1/images/button_faq.gif" name="button_faq"></a><br>
  <a href="launchReportBug.php"
    onMouseOver="imgOn('button_reportbug')"
    onMouseOut="imgOff('button_reportbug')">
    <img border=0 src="http://media.toontown.com/toontown//sv1.3.1/images/button_reportbug.gif" name="button_reportbug"></a><br>
  ...
  <img border=0 onClick="playClick()" onMouseOver="imgOn('play')" onMouseOut="imgOff('play')"
        src="http://media.toontown.com/toontown//sv1.3.1/images/button_play.gif" name="play"><br>
  </td></tr>
  <tr><td valign=top><img width=121 height=57 src="http://media.toontown.com/toontown//sv1.3.1/images/vrstudio_logo.gif"></td></tr>
</table></td>
<td align=left valign=top><img border=0 width=42 height=438 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_leftTrim1.jpg"></td>
<td align=left valign=top><img border=0 width=434 height=38 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_headerTrim1.jpg"><br>
<img width=434 height=400 border=0 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_center.jpg">
...
<td valign=top align=left><img border=0 width=47 height=438 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_rightTrim1.jpg"></td>
<td valign=top align=left><img border=0 width=74 height=438 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_rightBar.jpg"></td>
...
<img 
  src="http://ehg-dig2.hitbox.com/HG?hc=we19&cd=1&hv=6&ce=u&hb=DM510717H8BB38EN3&n=home&vcon=/toontown/play&seg=&cp=&gp="
  border='0'
  width='1'
  height='1'
  ></body>
