...
<!--
/* alert("http://download.toontown.com/sv1.0.9.27.1/tt_test.cab#Version=1,0,14,16");*/
if(InternetExplorer()) {
      document.writeln('<OBJECT CLASSID="CLSID:C02226EB-A5D7-4B1F-BD7E-635E46C2288D"');
    document.writeln('CODEBASE="http://download.toontown.com/sv1.0.9.27.1/ttinst.cab#Version=1,0,14,16"');
