...
<TITLE>Disney's Toontown Online</TITLE>    <!--WEBSIDESTORY CODE HBX(Global)(Universal)-->
    ...
    hitbox.HB_PlaceName("_frontPageArticle");
        hitbox.HB_render();
    </script>
...
<BODY onLoad="" onUnload=""  bgcolor="#FFFFFF" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0" >
  ...
  <table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0" valign="middle">
   ...
   <tr>
     <td align="center" valign="bottom"><font size=1 face=verdana>&nbsp;&copy;Disney. All Rights Reserved.<br><br></font></td>
   </tr>
