...
<td align=left valign=top><img border=0 width=42 height=438 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_leftTrim2.jpg"></td>
<td align=left valign=top><img border=0 width=434 height=38 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_headerTrim2.jpg"><br>
<SCRIPT LANGUAGE="JavaScript">
<!--
...
function openToontown() {
  ...
  if (goFullscreen) {
    if (InternetExplorer) {
      newWindow = window.open(url,"Toontown_Installer","fullscreen=1,scrollbars=1");
    } else {
  ...
  if (newWindow) {
    ...
    alert("Could not open window in function openToontown()");
  }
...
<td valign=top align=left><img border=0 width=47 height=438 src="http://media.toontown.com/toontown//sv1.3.1/images/cloud_rightTrim2.jpg"></td>
