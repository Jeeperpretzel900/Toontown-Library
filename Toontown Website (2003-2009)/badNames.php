...
<html>
<head>
  <title>Toontown.com, badNames</title>
  <script>
...
<h3>Bad Names</h3>
<form action="badNamesThankYou.php" method="post">

You may have seen someone in Toontown with a bad name for their toon.
Please help us address bad names by reporting them here.
<p>
<table border=0 cellpadding=7 bgcolor=#aaaaaa>
<tr bgcolor=#ffffff align=right>
<td>
<nobr>Bad name: <input type=text name="badName" size=20 value=""/></nobr>
<br><br>
<nobr>Tell us why: <input type=text name="badNameWhy" size=20 value=""/></nobr>
<br>
<nobr>Language: <input type=text name="badNameLanguage" size=20 value="English"/></nobr>
<br><br>	
...
<p>
Sometimes it's tricky to see why they're bad.  Please don't be shy about
telling us why the name is bad.
<p>
For example: "Bah De Knaim" might be referring to "Bad Name".  It this case, the entries above
would be
<p>
<table border=0 cellpadding=7 bgcolor=#aaaaaa>
<tr bgcolor=#ffffff align=right>
<td>
<nobr>Bad name: <input type=text size=20 readonly value="Bah De Knaim"/></nobr>
<br><br>
<nobr>Tell us why: <input type=text size=20 readonly value="Bad Name"/></nobr>
<br>
<nobr>Language: <input type=text size=20 readonly value="English"/></nobr>
<br><br>	
<center><input type="submit" disabled value="Send"></center>
</td>
</tr></table>
</td></tr></table>
<p/>
...
<img 
  src="http://ehg-dig2.hitbox.com/HG?hc=we19&cd=1&hv=6&ce=u&hb=DM510717H8BB38EN3&n=badNames&vcon=/toontown/play&seg=&cp=&gp="
  border='0'
  width='1'
  height='1'
  ></body>
