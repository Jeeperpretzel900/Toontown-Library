...
<TITLE>Toons of the World Unite!</TITLE>    <!--WEBSIDESTORY CODE HBX(Global)(Universal)-->
    ...
    hitbox.HB_PlaceName("_popups_emailLetter");
        hitbox.HB_render();
    </script>
...
<table align="center" width="75%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td colspan="3" align="center">
      <img src="http://play.toontown.com/images/email_a_friend1.jpg" width="550" height="410" alt="Your Invitation to Fun and Excitement..." border="0">
    </td>
  </tr>
  <tr>
    <td width="35"></td>
    <td align="justify">
      ...
      <b>Dear ,</b><br><br>
  has asked us to send you an invitation to play Disney's Toontown Online - the award-winning multiplayer game filled with non-stop play, ever-changing adventure, and irreverent fun.<br><br>
 To meet up with  and check out a <b>free trial</b> of the most outrageous online game in the Tooniverse, just click on the 'Play Now' button below.<br><br>
 There is so much to do...      </font>
    </td>
    <td width="35"></td>
  </tr>
  <tr>
    <td colspan="3" align="center">
      <br>
      <img src="http://play.toontown.com/images/buttons/playnow_waiting.gif" border="0" width="200" height="80" alt="Play Now"><br>
      <hr>
      <br>
