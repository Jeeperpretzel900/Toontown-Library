...
function nextImage() {
  if (canDo) {
    i = 1 + 1;
    if  (i > maxImages) { i = 1; }
    //document.images.slideimage.src="http://play.toontown.com/contests/images/" + i +".";
    //document.images.slidelabel.src="http://play.toontown.com/contests/images/" + i +".";
    location.href = "http://play.toontown.com/popups/valentineSlideShow2005.php?inum=" + i;
  }
}
...
<tr>
  ...
  <td align="center" valign="middle"><img src="http://play.toontown.com/contests/images/elizabeth_w_7_miller_place_ny.gif" alt="Honorable Mention" name="slideimage" id="slideimage" width="287" height="255" border="0"></td>
