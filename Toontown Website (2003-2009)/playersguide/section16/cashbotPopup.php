...
<TITLE>Toontown Official Player's Guide - Cashbot HQ</TITLE>    <!--WEBSIDESTORY CODE HBX(Global)(Universal)-->
    ...
    hitbox.HB_PlaceName("_playersguide_section16_cashbotPopup");
        hitbox.HB_render();
    </script>
...
<table align="center" width="75%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td align="center">
      ...
      <img src="images/Chart_cashbot_RobberBaron.jpg" width="594" height="459" alt="Earning a Cashbot Promotion" border="0">
      <br>
