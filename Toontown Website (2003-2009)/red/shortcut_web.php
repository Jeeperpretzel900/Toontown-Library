...
<meta http-equiv="imagetoolbar" content="no">
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      ...
      hitbox.HB_PlaceName("_red_shortcut_web");
...
<body onload="window_onLoad(); " onunload=""  bgcolor="#ffffff" style="margin-top:0;margin-bottom:0;" >
...
<!--
  ...
  function goToUK() {
    location.replace('http://www.disney.co.uk/toontown/index.jsp');
  } 
  

  function goToUS() {
    location.replace('http://play.toontown.com');
  } 
