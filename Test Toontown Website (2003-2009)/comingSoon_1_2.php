...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>
    ...
    <td align="right"><span class="bold">2 of 2</span></td>
  </tr>
  <tr>
    <td colspan="2" class="txtSmall">Issue 1, February 20, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br><img src="/shared/images/toonHQ.gif" width="319" height="84" alt="Toon HQ to Add Leader Board" border="0"><br><br></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><img src="/shared/images/HQimage.jpg" width="279" height="187" alt="" border="0"><br><br></td>
  </tr>
  <tr>
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">The Toon Council has decided to recognize leaders within the Toon community by erecting Toon Leader Boards. Leader boards will be placed inside each Toon HQ and show the ten Toons who have rescued the most buildings in Toontown. These top Toons will be known as the "Toon Platoon", the ultimate defenders of Toontown.</p>
          </td>
        </tr>
      </table>
      <!-- START COLUMN 1 -->
    ...
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">Each district will have a different Leader Board. Remember - if the buildings you rescue get taken over by Cogs again, you lose credit for that building. Also - if you switch districts, your building credit does not travel with you. Do your best to earn your place amongst the bravest Toons in Toontown!</p>
          </td>
        </tr>
      </table>
      <!-- END COLUMN 2 -->
  ...
  <tr>
    <td colspan="2" align="center">
      <br><br>
      <a href="comingSoon_1_1.php"><img src="/shared/images/previousButton.jpg" width="92" height="25" alt="Previous" border="0"></a>
    </td>
  <tr>
  <tr>
...
<!-- END MIDDLE CONTENT -->
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=02022011&amp;topToonURL=/shared/images/dynamic/topToonImages/2011_02_02_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=http://play.test.toontown.com/topToons.php&amp;imageFileURL=/dynamic/topToonImages/2011_02_02_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/poll_small.swf?basePollPath=/shared/www/&amp;pollId=463&amp;alreadyAnswered=false&amp;pollType=undefined", // swf
           "154", //width
           "208", // height
           "#ffffff", // background
           "", // version
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_comingSoon_1_2';
