...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr>
    <td colspan="2" class="txtSmall">Issue 4, May 20, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br><img src="/shared/images/toonestates.gif" width="333" height="73" alt="Toon Estates to Open" border="0"><br><br></td>
  </tr>
  <tr>
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">Have you planned your housewarming party?  Get those invitations ready, because Toon Estates are coming!  Soon, the map page in your Shticker book will have a new "Go Home" button -- click this to teleport to your new pad!</p>
            <br><br>
            <img src="/shared/images/gohomeImage.jpg" width="200" height="133" alt="" border="0">
            <p align="justify">Your place will be stocked with basic home furnishings and an empty closet to hold all your snazzy future outfits. You'll also have a new piggy bank to stash all those extra jelly beans you've earned in the trolley games and toon tasks.And this is just the beginning! New features will be released over the next few months to make your home an even more exciting place!</p>
            <br><br>
          </td>
        </tr>
      </table>
    ...
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><br><img src="/shared/images/homeImage2.jpg" width="200" height="145" alt="" border="0"><br><br></td>
        </tr>
        <tr>
          <td align="center">
            <p align="justify">Remember, your house is a safe haven where you can rest up and acquire laff points, just like the playgrounds. Absolutely no COGS allowed!</p>
            <br><br>
            <img src="/shared/images/pigImage.jpg" width="200" height="158" alt="" border="0">
          </td>
        </tr>
      </table>
      <!-- END COLUMN 2 -->
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_comingSoon_4_1';
