...
<html><head><title>About Cog Bucks</title>
...
<table cellpadding="10" cellspacing="0" border="0">
  <tr>
    <td><a name="top">
      <img src="/shared/images/billboards/cogBucks.gif" width="193" height="222" alt="" border="0">
    </td>
    <td>
    
      <img src="/shared/images/headers/aboutCogBucks.gif" width="243" height="31" alt="" border="0">
      <br><br>
  
      <font face="arial, verdana, helvetica" size="2">

        <b>What are Cog Bucks?</b><br>
        ...
        <b>How do I get Cog Bucks?</b><br>

        You can earn Cog Bucks by participating in the Recruit-a-Toon program. Cog Bucks are 
        also occasionally available through special promotions.

        <p/>

        <b>Will I be charged any fees for using a Cog Bucks certificate? </b><br>

        No. There is no charge for using a Cog Bucks certificate.

        <p/>

        <b>How do I continue my membership when my Cog Bucks certificate expires? </b><br>
