...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>
    ...
    <td align="right" class="bold">1 of <a href="backStage_1_2.php">2</a></td>
  </tr>
  <tr>
    <td colspan="2" class="txtSmall">Issue 1, February 20, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><img src="/shared/images/cogHQ.gif" width="386" height="85" alt="Cog HQ Construction Breaks Ground" border="0" vspace="10"><br><br></td>
  </tr>
  <tr>
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">
              Cog Headquarters is shaping up to be a much larger design than originally anticipated. The team is incredibly excited to finally be working on Cog HQ. We think we will have some really new and engaging experiences to offer when everything is complete.<br><br>

          Current Design
          <br><img src="/shared/images/divider.gif" width="200" height="1" alt="" border="0"><br>
          The story concept centers on the Cogs taking Toon prisoners. The Cogs have created permanent embankments on the outskirts of Toontown and are capturing and holding storekeeper Toons hostage. Groups of Toons will need to battle their way through numerous complex and unique areas to reach the final confrontation and rescue the captured Toons.<br><br>
  ...
  <!-- START COLUMN 2 -->
    <table width="200" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><img src="/shared/images/cogHqImage.jpg" width="200" height="149" alt="" border="0"><br><br></td>
      </tr>
      <tr>
        <td align="center">
          <p align="justify">
          ...
          <br><br>Cog Headquarters will not actually be one building, but rather an entire neighborhood in itself. Outside the main HQ building will stand factories that create the Cogs. Pictured above is a screenshot of a blocking model of the "Arm Factory". Toons will be able to group up and enter the factories to battle Cogs inside.
        </td>
      </tr>
    </table>
  <!-- END COLUMN 2 -->
  ...
  <tr>
    <td colspan="2" align="center"><br><a href="backStage_1_2.php"><img src="/shared/images/nextButton.jpg" width="92" height="25" alt="" border="0"></a></td>
  </tr>
  <tr>
...
<!-- END MIDDLE CONTENT -->
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=10072010&amp;topToonURL=/shared/images/dynamic/topToonImages/2010_10_07_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=http://play.test.toontown.com/topToons.php&amp;imageFileURL=/dynamic/topToonImages/2010_10_07_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
