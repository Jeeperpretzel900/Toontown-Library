...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr>
    <td colspan="2" class="txtSmall">Issue 7 July 16, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br><img src="/shared/images/TTCS_title_07.gif" width="374" height="82" alt="Count Your Beans And Get The New Goods" border="0"><br>
    <br></td>
  </tr>
  <tr>
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">Hey all you shop-a-holics, get ready to spend! Hope you have been saving up your jelly beans, because the first catalog will arrive at your estate in the next few weeks.<br><br>Spruce up your house with new floors and wallpaper, learn how to applaud for other Toons in acting class, update your look with a new outfit! And that's not all -- Your bedroom will be the swankiest pad in all of Toontown with a brand-new bathtub bed!</p>
            <br> 
            <img src="/shared/images/TTCS_graphic_07_02.jpg" width="200" height="228">
          </td>
        </tr>
      </table>
      <!-- START COLUMN 1 -->
    ...
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <br>
            <img src="/shared/images/TTCS_graphic_07_01.jpg" width="200" height="156">      
            <br><br>
          </td>
        </tr>
        <tr>
          <td align="center">
            <br><br>
            <p align="justify">But this fun stuff ain't for free -- the bigger and more exclusive the item, the more beans it will cost you. So spend your beans wisely!<br><br>Clarabelle the operator will be standing by to take your call. Remember, these goodies are available in limited supplies so you will need to act fast.</p>
          </td>
        </tr>
      </table>
      <!-- END COLUMN 2 -->
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_comingSoon_7_1';
