...
<html>
<head>
<title>How do I uninstall Toontown in OS X?</title>
...
<meta http-equiv="imagetoolbar" content="no">
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      ...
      hitbox.HB_PlaceName("_faq_technical_mac_uninstall");
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr>
    <td valign="top"><p>
      ...
      do I uninstall Toontown in OS X?</em></strong></font>
      <p><em><strong><font size="2" face="Arial, Helvetica, sans-serif"><font color="#0000FF">A:</font></font></strong><font size="2" face="Arial, Helvetica, sans-serif"></font></em><font size="2" face="Arial, Helvetica, sans-serif">
      To completely uninstall Toontown from computer, please follow all of the instructions below:
<ol>
<li>Open the Mac Finder.<br/><br/>
      To remove the Toontown Game Client please do the following:<br/><br/>
<li>Select your Home Directory -> Library Folder -> Application Folder.
<li>Select the WDIG Folder and drag to your Trash.<br/><br/>
      To remove the Toontown Application:<br/><br/>
<li>Next the Mac Harddrive -> Applications.
<li>Drag the Toontown Application to your Trash.<br/><br/>

      To remove the Toontown Plugin, please do the following:<br/><br/>
<li>Next Select Mac Harddrive -> Library -> Internet Plugins.
<li>Drag the toontownbundlemanager.plugin to the Trash.
</ol>
