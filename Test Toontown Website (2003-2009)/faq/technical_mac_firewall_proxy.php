...
<html>
<head>
<title>Can I play Toontown through the OS X Firewall?</title>
...
<meta http-equiv="imagetoolbar" content="no">
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      ...
      hitbox.HB_PlaceName("_faq_technical_mac_firewall_proxy");
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>   <td align="center"><img src="/shared/images/TT_FAQ_title_technical_mac.gif" width="431" height="100"><br><br> </td>
  </tr>
  <tr>
    <td valign="top"><p>
      <font size="2" face="Arial, Helvetica, sans-serif"><strong><em><font color="#0000FF">Q:</font> Can I play Toontown through the OS X firewall?</em></strong></font>
      <p><em><strong><font size="2" face="Arial, Helvetica, sans-serif"><font color="#0000FF">A:</font></font></strong><font size="2" face="Arial, Helvetica, sans-serif"></font></em><font size="2" face="Arial, Helvetica, sans-serif"> Yes,
          ...
          Toontown uses to connect to its game server. If your OS X firewall is enabled you must do the following to configure it to work with Toontown:
<ol>
<li>Open the Apple Menu. 
<li>Click System Preferences. 
<li>In the System Preferences window, click on Sharing. 
<li>Click on the Firewall tab, then click New.
<li>Select Other from the Port Name drop-down menu. 
<li>Enter 443, 80, 6667 in the Port Number, Range, or Series field, and Toontown Mac Client as the Description, then click OK. 
<li>Finally, take a look at the bottom of the Allow list. It should now contain the Toontown entry.
<li>You can now close the Sharing window. Congratulations! Your firewall should now allow traffic on the necessary ports to play Toontown from your Mac.
</ol>
