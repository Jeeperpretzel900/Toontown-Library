...
<html><head><title>What kind of Mac is needed to play Toontown?</title>
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <script type="text/javascript">
    <!--
    tech_mac = create_tech_mac()
    //Begin - display image header  
    displayFaqHeader(tech_mac)  
    //End - display image header  
    -->
  </script>       
  <tr>
    <td>
      <p><span class="faqQA">Q:</span><span class="faqQ">What kind of Mac is needed to play Toontown?</span></p>
      <p><span class="faqQA">A:</span>To run Toontown from your Mac you must meet the following minimum requirements:</p>    
      <ul>
        <li>PowerPC 450 MHz or any Mac with an Intel processor</li>
        <li>256 MB of RAM</li>
        <li>300MB free space on your hard drive</li>
        <li>A 32 MB video card</li>
        <li>A 56K modem, or a faster Internet connection</li>
        <li>OS X 10.4.6 (Tiger) or newer</li>
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_faq_tech_mac_minimum_reqs';
    cto.registrationStatus='prospect';
    cto.genre='us';//country
    cto.account='toontown';
    cto.category='dgame';
    cto.site='tnt_beta';
    cto.siteSection='website:faq:tech:mac';
