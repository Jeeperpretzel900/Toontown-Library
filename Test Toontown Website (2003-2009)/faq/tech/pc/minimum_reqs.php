...
<html><head><title>What kind of PC computer is needed to play Toontown?</title>
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <script type="text/javascript">
    <!--
    tech_pc = create_tech_pc()
    //Begin - display image header  
    displayFaqHeader(tech_pc)  
    //End - display image header
    -->
  </script> 
  <tr>
    <td>
      <p><span class="faqQA">Q:</span><span class="faqQ">What kind of PC computer is needed to play Toontown?</span></p>
      <p><span class="faqQA">A:</span>You must have a Windows PC with Internet Explorer, Firefox, or Opera. You also need:</p>
      <ul>      
        <li>Microsoft Windows</li>
        <li>98, ME, 2000, or XP or Vista</li>
        <li>Pentium III 500 MHz or faster CPU</li>
        <li>256MB RAM memory</li>
        <li>150MB free space on your &quot;\Program Files&quot; hard drive<br> (most likely C:)</li>
        <li>32 MB 3D graphics card</li>
        <li>A 56K modem, or a faster Internet connection</li>
        <li>Microsoft DirectX 9.0c (or newer)</li>
        <li>Microsoft Internet Explorer v. 5.1 (or newer)</li>
	<li>Firefox v. 2 (or newer)</li>
	<li>Opera v. 9 (or newer)</li>
      </ul>         
    </td>
  </tr> 
<p>Please note that Toontown is currently only compatible with operating systems running in 32-bit mode.</p>
  <script type="text/javascript">
    <!--    
    //Begin - display Faq Content            
    displayFaqContent(tech_pc) 
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=02082010&amp;topToonURL=/shared/images/dynamic/topToonImages/2010_02_08_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=http://play.test.toontown.com/topToons.php&amp;imageFileURL=/dynamic/topToonImages/2010_02_08_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/poll_small.swf?basePollPath=/shared/www/&amp;pollId=412&amp;alreadyAnswered=false&amp;pollType=undefined", // swf
           "154", //width
           "208", // height
           "#ffffff", // background
           "", // version
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_faq_tech_pc_minimum_reqs';
    cto.registrationStatus='prospect';
    cto.genre='us';//country
    cto.account='toontown';
    cto.category='dgame';
    cto.site='tnt_beta';
    cto.siteSection='website:faq:tech:pc';
    cto.pageName='minimum_reqs';
