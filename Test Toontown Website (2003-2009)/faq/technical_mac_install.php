...
<html>
<head>
<title>How can I install Toontown in OS X?</title>
...
<meta http-equiv="imagetoolbar" content="no">
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      ...
      hitbox.HB_PlaceName("_faq_technical_mac_install");
...
<!-- START MIDDLE CONTENT -->
    ...
    <title>How do I install Toontown in OS X? </title>
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr>
    <td valign="top"><p>
      ...
      do I install Toontown in OS X?</em></strong></font>
...
<ol>
      <li>At the Toontown web site, click the red "Play" button.
<li>Log into your Toontown account with your username and password.
<li>On the page that says "Install Toontown," click "Next".
      <li>In the dialog box that appears, click "Continue" and follow the directions in the dialog boxes to finish installing. 
</ol>
