...
<html>
<head>
<title>How can I update OS X to work best with Toontown?</title>
...
<meta http-equiv="imagetoolbar" content="no">
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      ...
      hitbox.HB_PlaceName("_faq_technical_mac_update");
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr>
    <td valign="top"><p>
      <font size="2" face="Arial, Helvetica, sans-serif"><em><strong><font color="#0000FF">Q:</font> How can I update OS X to work best with Toontown?</strong></em></font>
      <p><em><strong><font size="2" face="Arial, Helvetica, sans-serif"><font color="#0000FF">A:</font></font></strong><font size="2" face="Arial, Helvetica, sans-serif"></font></em><font size="2" face="Arial, Helvetica, sans-serif"> The problem that you experienced may be resolved by updating the software on your Mac. Apple frequently releases updates to your computer's software. The Software Update feature in Mac OS X makes it very easy to determine and get exactly what you need.</p>
<p>To get updates immediately: 
 
<ol>
<li>From the Apple Menu, choose Software Update 
<li>Click the Check Now button (or Update Now in earlier Mac OS X versions).
<li>In the Software Update window, select the items you want to install, then click Install. 
<li>Enter an administrator account name and password. 
<li>After the update is complete, restart the computer if required. 
<li>Repeat these steps to see if more updates are now available. Because some software updates are prerequisites for others, you may need to repeat these steps several times to complete the software update sequence. 
</ol> </font></p>
 ...
 <table width="100%" border="0">
    ...
    <!-- END MIDDLE CONTENT -->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj = new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=10212007&amp;topToonURL=/shared/images/dynamic/topToonImages/2007_10_21_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=http://play.test.toontown.com/topToons.php&amp;imageFileURL=/dynamic/topToonImages/2007_10_21_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
