...
<html><head><title>What if I can't find enough buildings to defeat, or my particular building?</title>
<meta name="robots" content="follow,noindex" />
<meta http-equiv="imagetoolbar" content="no" />
<link type="text/css" rel="stylesheet" href="http://play.test.toontown.com/shared/include/css/global.css">
<script type="text/javascript" src="http://play.test.toontown.com/shared/include/js/faq.js"></script>
    ...
    <script src = "http://hb.disney.go.com/stat/hitboxcode.js" type="text/javascript"></script>
      ...
      hitbox.HB_PlaceName("_faq_gags_and_cogs_building_to_complete_task");
      ...
      <tr>
          ...
          <!--
            flashObj = new FlashObj(
              "/shared/images/flash/leftnav.swf?exitSignUpUrl=http://play.test.toontown.com/news.php&amp;navXML=http://play.test.toontown.com/shared/include/xml/nav.xml?v=4b&amp;username=&amp;baseplayurl=http://play.test.toontown.com/&amp;baseaccounturl=https://account.test.toontown.com/&amp;exitSignUpHbx=leftnav_exitsignup&amp;baseHbx=/Toontown/US/Beta/PROSPECT/&amp;memberServicesUrl=MEMBERSERVICES&amp;emailPrefUrl=http://play.test.toontown.com/unavailableOnTestServer.php&amp;changePwdUrl=http://play.test.toontown.com/unavailableOnTestServer.php&amp;memberInfoUrl=http://play.test.toontown.com/unavailableOnTestServer.php&amp;billingInfoUrl=http://play.test.toontown.com/unavailableOnTestServer.php&amp;", // swf
              "154", //width
              "1050", // height
              "#ffffff", // background
              "", // version
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <script type="text/javascript">
    <!--
    gags_and_cogs = create_gags_and_cogs()
    //Begin - display image header  
    displayFaqHeader(gags_and_cogs)  
    //End - display image header  
    -->
  </script>       
  <tr>
    <td>
      <p><span class="faqQA">Q:</span><span class="faqQ">What if I can&#39;t find enough buildings to defeat, or my particular building?</span></p>
      <p><span class="faqQA">A:</span>You might try checking other districts via the &quot;Districts&quot; page in your Shticker Book. By transferring to one of the other districts you are more likely to find your building.</p>    
    </td>
  </tr>
  <script type="text/javascript">    
    <!--      
    //Begin - display Faq Content            
    displayFaqContent(gags_and_cogs) 
    //End - display Faq Content    
    -->  
  </script>
</table>
    ...
    <!-- END MIDDLE CONTENT -->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj = new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=11072008&amp;topToonURL=/shared/images/dynamic/topToonImages/2008_11_07_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=http://play.test.toontown.com/topToons.php&amp;imageFileURL=/dynamic/topToonImages/2008_11_07_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
       ...
       <!--
         flashObj = new FlashObj(
           "/shared/images/flash/poll_small.swf?basePollPath=/shared/www/&amp;pollId=346&amp;alreadyAnswered=false&amp;pollType=displayed", // swf
           "154", //width
           "208", // height
           "#ffffff", // background
           "", // version
...
var legalFtrCpyRgt = '<div style="font: verdana, arial, helvetica, sans-serif 1pt; color:#000000;"><a href="http://play.test.toontown.com/memberAgreement.php">Member Agreements</a>&nbsp;|&nbsp;<a href="http://home.disney.go.com/guestservices/netiquette">House Rules</a><br>&copy; Disney. All rights reserved.';
</script>
