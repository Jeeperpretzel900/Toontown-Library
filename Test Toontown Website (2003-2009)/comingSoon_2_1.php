...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr>
    <td colspan="2" class="txtSmall">Issue 2, April 22, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br><img src="/shared/images/newtrolley.gif" width="361" height="72" alt="New Trolley Stop Opens" border="0"><br><br></td>
  </tr>
  <tr>
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">Now available off the trolley is a "catchy" new way to fill up your jelly bean bags!<br><br>
            You and up to 3 of your favorite Toon friends take on the task of catching armfuls of falling fruit. You'll need cat-like reflexes and an eagle-eye because (surprise!) the Cogs are out to spoil your fruit-collecting fun.</p>              
            <img src="/shared/images/toongameImage.jpg" width="200" height="150" alt="" border="0">
          </td>
        </tr>
      </table>
      <!-- START COLUMN 1 -->
    ...
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><br><img src="/shared/images/treeImage.jpg" width="200" height="160" alt="" border="0"><br><br></td>
        </tr>
        <tr>
          <td align="center">
            <p align="justify"><br>Don't fret, however - you've got back-up. A few friendly Toons are hiding out in the trees to launch anvils at the evil Cogs. Just be careful to avoid those heavy hitters - it's fruit you want, and more fruit equals more jelly beans!</p>
          </td>
        </tr>
      </table>
      <!-- END COLUMN 2 -->
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_comingSoon_2_1';
