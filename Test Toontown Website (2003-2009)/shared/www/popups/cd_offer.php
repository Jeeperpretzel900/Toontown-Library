...
<TITLE>CD Offer</TITLE>    <!--WEBSIDESTORY CODE HBX(Global)(Universal)-->
    ...
    hitbox = new HB_CreateObject("/toontown/US/PROSPECT/LAUNCH");
    hitbox.HB_PlaceAccount("DM510925KJWE38EN3","DM510612FMNS38EN3","DM51030813MR38EN3","DM5103083LCA38EN3");
    hitbox.HB_PlaceName("_shared_www_popups_cd_offer");
        hitbox.HB_render();
    </script>
...
<div align="center" valign="center">
  <img src="/shared/images/400_Install_popup.jpg" width="400" height="400" usemap="#cdoffermap" border="0" alt="Toontown now available on a CD-ROM at a retail store near you!">
</div>
