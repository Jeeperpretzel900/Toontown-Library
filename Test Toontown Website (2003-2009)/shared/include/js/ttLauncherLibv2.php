...
function _embedInstaller(includeCodeBase)
{
  ...
  logDebug("_embedInstaller", "ActiveX is at 'http://download.test.toontown.com/sv1.0.39.36.test/tt_test.cab#Version=1,0,19,5' and classID 'FF791555-FDAC-43ab-B792-389E4CC0A6E5'");
  document.writeln('<object classid="CLSID:FF791555-FDAC-43ab-B792-389E4CC0A6E5"');
  if (includeCodeBase) {
    document.writeln('  codebase="http://download.test.toontown.com/sv1.0.39.36.test/tt_test.cab#Version=1,0,19,5"');
  }
...
{
  setTargetURL('ACTIVEXINITFAIL',    'http://play.test.toontown.com/ActiveXproblem.php');
  setTargetURL('HARDWARECHECKFAIL',  'http://play.test.toontown.com/missedRequirements.php');
  setTargetURL('HARDWARECHECKOK',    'http://play.test.toontown.com/test/hasHardware.php');
  setTargetURL('GRAPHICSCHECKFAIL',  'http://play.test.toontown.com/graphicsDrivers.php');
  setTargetURL('REPORTPROBLEM',      'http://play.test.toontown.com/reportBug.php?reportproblem=1');
  setTargetURL('GAMEFAIL',           'http://play.test.toontown.com/reportBug.php?reportproblem=0');
  setTargetURL('GAMEOK',             'https://account.test.toontown.com/thanksForPlaying.php');
  setTargetURL('ENABLECHAT',         'https://account.test.toontown.com/webChangeChat.php');
  setTargetURL('SETPARENTPASSWORD',  'https://account.test.toontown.com/webSetBilling.php');
  setTargetURL('PURCHASE',           'http://play.test.toontown.com/unavailableOnTestServer.php');
}
...
function installerExit()
{
  ...
  if (initialized) {
      ...
      && deployment == 'US' )
    {
      ...
      httpReq.open("GET", "http://play.test.toontown.com/services/sendIncompleteDownload.php", true);
      httpReq.send(null);
    } else {
