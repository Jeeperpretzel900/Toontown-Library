...
<table width="860" height="207" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td rowspan="3"><img src="/imgs/error.gif" width="395" height="207" alt="エラー"></td>
...
<table cellpadding="0" cellspacing="0" border="0" width="688">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="583">
													...
													<tr>
														...
														<!-- tr>
														<td colspan="3"><img src="/imgs/0.gif" width="316" height="2"></td>
														</tr -->
														<tr>
														<td><img src="/imgs/0.gif" width="5" height="1"></td>
														<td width="306" align="center"><font size="3" color="#ff0000">予期せぬエラーが起こりました。<br><br>メンテナンス情報は<a href="/news.html">こちら</a>から確認してください。<br><br>しばらくしてからもう一度アクセスしていただいた結果、それでもつながらない場合はディズニーBBカスタマサポートにお問い合わせください。</font></td>
														<td><img src="/imgs/0.gif" width="5" height="1"></td>
														</tr>
														<tr>
														<td colspan="3" align="center"><a href="javascript:history.go(-1)"><img src="/imgs/back.gif" width="145" height="45" alt="戻る" border="0"></a></td>
														</tr>
														</table>
														<!--　コンテンツ内容  -->
														</td>
