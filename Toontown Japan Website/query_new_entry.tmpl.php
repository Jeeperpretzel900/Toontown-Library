											  ...
											  <table cellpadding="0" cellspacing="0" border="0" width="583">
													...
													<tr>
														...
														<table border="0" cellspacing="10" cellpadding="0" width="524">
														  ...
														  <tr valign="top"> 
														    <td align="right"> <font color="#000000" size="-1" class="fs12"><b>ユーザーＩＤ<br>（必須）</b><br>
														      </font> </td>
														    <td align="left"> <font size="-1"> 
														      <input type="text" name="user_id" size="40" value="">
														      <br>
														      <font color="#000000" class="fs10">※未登録の方は「未登録」、ユーザーＩＤを忘れた方は「忘れた」と入力してください。</font><br>
														      </font></td>
														  </tr>
														  <tr valign="top"> 
