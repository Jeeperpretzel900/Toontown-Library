...
<html>
<head>
  <title>Toontown.com, launcingReportBug</title>
  <script>
...
<body bgcolor="#4477ff" text=#000000 link=#4477ff vlink=#4455bb alink=#ff5555
    leftmargin=0 topmargin=0 marginwidth=0 marginheight=0 onload="return openReportBug()" >
...
function openReportBug() {
  ...
  if (InternetExplorer) {
    ...
    location.href = getThisServerURL() + "noLogsReportBug.php";
  }
}
//-->
</SCRIPT>

<h3>Starting Report Bug...</h3>
<p/>
<div align="CENTER">
